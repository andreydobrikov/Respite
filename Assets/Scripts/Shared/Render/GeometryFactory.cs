...
public class GeometryFactory : MonoBehaviour 
{
	...
	public void RebuildMesh()
	{
		...
		if(mesh != null)
		{
			if(ScaleUVs)
			{
				mesh.sharedMesh = CreatePlane(transform.localScale.x * UVScale0, transform.localScale.y * UVScale0, transform.localScale.x * UVScale1, transform.localScale.y * UVScale1);		
			}
			else
			{
